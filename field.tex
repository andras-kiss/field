...
\caption{An electric field is formed between the surfaces of the galvanic couple. The potential difference between the measuring ($\phi_2$) and reference electrode ($\phi_1$) is added to the nernstian potential associated with the activity of the ion which the measuring electrode is selective to.}
\label{fig:abstract}
\end{figure}
