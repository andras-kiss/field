...
In fig. \ref{fig:2d}B the measured values are in the linear range of the ISME, and the overall potential change is several orders of magnitude smaller than in fig. \ref{fig:2d}A. It has to be mentioned that, during the second scan, that was recorded immediately following the electric discconnection of the two metals the lack of electric connection of the galvanic couple and the diffusion of the Mg$^{2+}$ ions can introduce incertainities in the evaluation of the image, yet does not lead to such impossible misinterpretation as fig. \ref{fig:2d}A.
