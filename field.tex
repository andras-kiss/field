...
\draw [line width=0.25mm, black, ->] (axis cs:790,-53.5) -- (axis cs:790,-49);
...
\draw [line width=0.25mm, black, ->] (axis cs:790,-22) -- (axis cs:790,14);
\node[black, left] at (axis cs:790,10) {$\Delta$E$_2$};

\draw [line width=0.25mm, black, ->] (axis cs:810,14) -- (axis cs:810,-18);
\node[black, right] at (axis cs:810,5) {$\Delta$E$_3$};

\draw [line width=0.25mm, black, ->] (axis cs:820,-49) -- (axis cs:820,-18);
\node[black, right] at (axis cs:820,-36) {$\Delta$E$_4$};
\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
